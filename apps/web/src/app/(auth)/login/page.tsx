...
import { BookOpen, Eye, EyeOff, Github, Chrome } from 'lucide-react';
        ...
        <div className="rounded-2xl border border-border bg-card/50 p-8 backdrop-blur-sm shadow-xl">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button className="inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium transition-colors hover:bg-muted">
